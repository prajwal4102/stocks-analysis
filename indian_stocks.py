...
url='https://priceapi.moneycontrol.com/techCharts/indianMarket/stock/history?symbol=INFY&resolution=1D&from='+str(start)+'&to='+str(end)+'&countback=20000&currencyCode=INR'
